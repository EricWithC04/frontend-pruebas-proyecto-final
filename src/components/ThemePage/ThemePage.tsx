                    ...
                    <div className='theme-container'>
                    {
                        exampleExercises.map((exercise: any) => (
                                <div className='exercise-item-container'>
                                    <div className='theme-item expanded exercise w-100' onClick={() => setViewExercises(!viewExercises)}>
                                        <p>{exercise.name}</p>
                                    </div>
                                    <div className={`theme-item-description w-100 ${viewExercises ? 'yes-display' : 'no-display'}`}>
